<template>
  <div class="root-container">
    ...
    <Login
      v-bind:isLoginError="isLoginError"
      v-if="!loginSuccess && !showRegistration"
      v-on:on-login="attemptLogin"
      v-on:open-registration="openRegistration"
    />
    <Registration v-if="showRegistration" v-on:on-success="onRegistrationSuccess"/>
    ...
    <div class="toaster">
      <transition name="ease">
        ...
        <div v-if="showToaster && registrationSuccess">Registration successful!</div>
      </transition>
    </div>
  </div>
</template>
