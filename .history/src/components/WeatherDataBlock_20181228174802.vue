    ...
    <div class="main-block">
      ...
      <span class="weather-info">
        ...
        <span class="temperature-block">
          ...
          <span v-on:click="isCelcius || toggleUnit()" v-bind:class="{active: isCelcius}">&deg;C</span>
          <i class="v-line"></i>
          <span v-on:click="isCelcius && toggleUnit()" v-bind:class="{active: !isCelcius}">&deg;F</span>
        </span>
      </span>
    </div>
