<template>
  <div class="root-container">
    <div class="bg" v-bind:style="{backgroundImage: getBackgroundImage}"></div>
    <div v-show="!showResults" class="overlay"></div>
    <div class="title">
      <span>weather</span>
...
export default {
  ...
  computed: {
    getBackgroundImage() {
      ...
      newImg.src = this.weatherData
        ? `url(https://loremflickr.com/1920/1080/${this.weatherData.name})`
        : `url(${this.bg})`;
      return newImg.src;
    }
  }
