<template>
  <div class="root-container">
    ...
    <div v-bind:style="{backgroundImage: this.weatherData && this.calculateLinearGradient()}" class="overlay"></div>
    <div class="title">
      <span>weather</span>
...
export default {
  ...
  methods: {
    ...
    calculateLinearGradient() {
      return `linear-gradient(to bottom right, rgba(64, 64, 64, ${this
        .weatherData.clouds / 100}), rgba(43, 43, 43, ${this.weatherData
        .clouds / 100})`;
    }
  }
};
